...
func _get_text() -> String:
	if get_data("just_completed"):
		return "From a mermaid you say? No no... I don't think we could make it work. While love is in the air though, please, take this flower to my beloved guarding the castle. Tell her only that it's from her secret admirer"
...
func _on_option_chosen(action_id: String):
	match action_id:
		"give_necklace":
			...
			Global.inventory_data.try_add_item("Flower")
			complete_quest()
